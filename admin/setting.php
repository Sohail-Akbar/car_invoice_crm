...
<body>
    ...
    <main class="main-content setting-container" id="mainContent">
        <div class="card mb-5">
            <h3 class="heading mb-4 custom-heading text-clr">Personal Information</h3>
            <form action="setting" method="POST" class="ajax_form">
                <div class="row mt-4">
                    <div class="col-md-6">
        ...
        <div class="card">
            <h3 class="heading mb-4 custom-heading text-clr">Change Password</h3>
